...
public class Main {
    ...
    private static Project printTestAWithCommands(User user) {
        ...
        try {
            ...
            result = projectFileManagement.saveProject(project, Config.FILE_TYPE_BLIF);
    ...
    private static void printTestATests(Project project) {
        ...
        testtmp = new HashMap<>();
        testtmp.put("a10", false);
        testtmp.put("b11", true);
        testtmp.put("c12", true);
        testtmp.put("d13", false);
        combinationsInput.add(new Combination(testtmp));

        testtmp = new HashMap<>();
        testtmp.put("a10", true);
        testtmp.put("b11", true);
        testtmp.put("c12", false);
        testtmp.put("d13", false);
        combinationsInput.add(new Combination(testtmp));
